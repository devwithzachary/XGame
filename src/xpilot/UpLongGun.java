...
/*
 * Power up class that doubles the ships bullet lifetime
 */
public class UpLongGun extends UpPower {
	
	/*
	 * Constructor that sets the colour of the sheild power up
	 */
	public UpLongGun(double sx, double sy){
		lifetime = 300;
		c = Color.yellow;
		 s = new Vector2D();
		 s.add(sx, sy);
	...
	/*
	 * If the power up was hit by a ship we double the ships bullets life
	 * (non-Javadoc)
