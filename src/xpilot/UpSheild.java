...
/*
 * Power up class that recharges the ships shield
 */
public class UpSheild extends UpPower {
	
	/*
	 * Constructor that sets the colour of the power up
	 */
	public UpSheild(double sx, double sy){
		lifetime = 1000;
		c = Color.red;
		 s = new Vector2D();
		 s.add(sx, sy);
	...
	/*
	 * If the power up was hit by a ship we reset the ships sheild power to 100
	 * (non-Javadoc)
