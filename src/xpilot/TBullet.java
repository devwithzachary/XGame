...
/*
 * Bullet class for turret bullets
 */
public class TBullet extends GameObject{
	int lifetime;

	//Create a bullet at the position of the turret that fired it
	//and keep it alive for the amount of time given
	public TBullet(GameObject ship, int life) {
		dead = false;
	...
	@Override
	/*
	 * Draw class for the bullet that just draws a red line
	 * (non-Javadoc)
