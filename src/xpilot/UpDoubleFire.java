...
/*
 * Power up class that doubles the ships shoot speed
 */
public class UpDoubleFire extends UpPower {
	
	/*
	 * Constructor that sets the colour of the power up
	 */
	public UpDoubleFire(double sx, double sy){
		lifetime = 300;
		c = Color.blue;
		 s = new Vector2D();
		 s.add(sx, sy);
	...
	/*
	 * If the power up was hit by a ship we half the ships shoot delay (making the ship fire twice as fast)
	 * (non-Javadoc)
